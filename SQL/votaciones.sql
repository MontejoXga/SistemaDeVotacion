...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-07-2024 a las 19:17:05
...
CREATE TABLE `candidatos` (
  ...
  `nom_candidato` varchar(100) NOT NULL,
  `ape_candidato` varchar(100) NOT NULL,
...
INSERT INTO `candidatos` (`id_candidato`, `nom_candidato`, `ape_candidato`, `nom_partido`) VALUES
(1, 'José Pedro', 'Castillo Terrones', 'Perú Libre'),
(2, 'Pedro Pablo', 'Kuczynski Godard', 'Peruanos Por el Kambio'),
(3, 'Ollanta Moisés', 'Humala Tasso ', 'Gana Perú'),
(4, 'Alan Gabriel', 'Ludwig García Pérez', 'Partido Aprista Peruano');
...
CREATE TABLE `votos` (
  ...
  `difusion1` varchar(100) NOT NULL,
  `difusion2` varchar(100) NOT NULL,
...
INSERT INTO `votos` (`id_voto`, `id_candidato`, `nombre`, `dni`, `fecha`, `difusion1`, `difusion2`, `alias`, `email`, `departamento`, `provincia`, `distrito`) VALUES
(13, 2, 'Marco Antonio Montejo Guevara', '72424916-2', '2024-07-31 10:11:49', 'redes sociales', '', 'asd12', 'lucaculud02@gmail.com', 22, 2208, 220801);
